...
class addCategoryRequest extends FormRequest
{
    ...
    {
        return [
            'name_en' => 'required|min:3|max:20|unique:App\Models\Category,name_en',
            'name_ru' => 'required|min:3|max:20|unique:App\Models\Category,name_ru',
            'name_lv' => 'required|min:3|max:20|unique:App\Models\Category,name_lv'
        ];
    }
